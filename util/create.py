...
def user(username=None, password=None, email=None, base_url="http://localhost:5000/api"):
    """Create a new user."""
...
def token(username, password, base_url="http://localhost:5000/api"):
    ...
    response_login = requests.post(base_url + "/auth/create-api-token", headers=headers)
